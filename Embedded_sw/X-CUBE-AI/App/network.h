...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "quantization_default_8bit_model_h5_to_tflite"
...
#define AI_NETWORK_IN_1_SIZE        (64 * 10 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  (2560/4)
